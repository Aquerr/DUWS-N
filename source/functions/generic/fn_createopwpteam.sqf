...
_group = [_position, EAST, [Opfor_Teamleader,Opfor_AA_Specialist,Opfor_AT_Specialist,Opfor_Autorifleman,Opfor_Rifleman,Opfor_Rifleman],[],[],opfor_ai_skill] call BIS_fnc_spawnGroup;
